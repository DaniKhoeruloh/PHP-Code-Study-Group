          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($conn,"SELECT * FROM tutor WHERE ID_TUTOR = '$id'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>
			<form class="form-horizontal" action="proses_updatetutor.php" method="post">
			 <div class="form-row">
				
				
				  <input type="hidden" class="form-control" name="id" value="<?= $d['ID_TUTOR'] ?>" >
